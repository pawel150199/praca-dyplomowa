...
"""Oversampled Random Sample Partition"""

class ORSP(BaseEnsemble, ClassifierMixin):

    def __init__(self, base_estimator=LinearSVC(), n_estimators=10, n_subspace_choose=1, n_subspace_features=3, hard_voting=True, random_state=None):
    ...
    def __oversample(self, X, y):
        """Oversampling"""
        preproc = SMOTE(random_state=self.random_state, k_neighbors=3)
