...
#Klasyfikatory
clfs = {
    'Bagging LSVC5' : RandomSubspaceEnsemble(base_estimator=KNeighborsClassifier(), n_estimators=8),
    'Bagging LSVC10': ORSE(base_estimator=KNeighborsClassifier(), n_estimators=8),
    'Bagging LSVC15': URSE(base_estimator=KNeighborsClassifier(), n_estimators=8)
}
